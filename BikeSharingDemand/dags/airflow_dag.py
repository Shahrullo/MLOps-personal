...
BUCKET_NAME = 's3b-bike-sharing-demand'
KEY = 'data/train.csv'
CURRENT_DIR = '/home/ubuntu/app/Bike-Sharing-Demand/'
TEST_SIZE = 0.2
TAG_MLFLOW = 'xgboost'
...
default_args = {
    "owner": "simon",
    "start_date": datetime(2023, 9, 25, 2), # days_ago(2)
    "end_date": datetime(2023, 12, 25, 2),
    "depends_on_past": False,
    "email": ["simon@example.com"],
    'email_on_failute': False,
...
with DAG(
    dag_id="bike_sharing_trainer_v1",
    default_args=default_args,
    description="Training DAG for bike sharing demand prediction",
    ...
    task_evaluate_data_drift = PythonOperator(
        task_id='evaludate_data_drift',
        python_callable=evaludate_data_drift,
    )
