...
def test_transform_data(the_dag: Any) -> None:
    ...
    local_dict = {
        ...
        "local_data_transformed_filename": "/home/ubuntu/app/Bike-Sharing-Data/data/bike_transformed.csv",
    }
...
def test_define_variables(the_dag: Any) -> None:
    ...
    params = {
        ...
        "s3_dict": {"bucket_name": "s3b-bike-sharing-demand", "key": "data/train.csv"},
        "local_dict": {"current_dir": "/home/ubuntu/app/WBike-Sharing-Demand/"},
    }
